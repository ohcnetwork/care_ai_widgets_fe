...
/**
 * Plugin component registered as EncounterOverviewTop.
 * Reads the user's enabled widgets and renders each one.
 */
export default function EncounterWidgets({ encounterId }: Props) {
